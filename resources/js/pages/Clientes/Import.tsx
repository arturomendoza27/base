...
export default function Import() {
  ...
  const handleImport = (e: any) => {
    ...
    router.post('/importar-excel', formData, {});
  };
  const downloadUrl = '/templates/importar_clientes.xlsx';
  return (
    <DashboardLayout>
      <Head title="Clientes" />
      <div className="space-y-6 max-w-4xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-balance">Importar Clientes</h1>
            <p className="text-muted-foreground">Formulario para la carga masiva de clientes</p>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Sube un archivo Excel para importar múltiples clientes</CardDescription>
                </CardHeader>
