...
export default function Create({ datos, filters }: CreateProps) {
    ...
    useEffect(() => {
        ...
        const delayDebounce = setTimeout(() => {
            fetch(`/clientes/search?q=${encodeURIComponent(search)}`)
                .then((res) => res.json())
                .then((filters) => setResults(filters));
        }, 400);
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative flex-1 max-w-sm">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => {
                                                        setData({ ...data, cliente_id: e.target.value })
