...
<body>
    ...
    <div class="factura-wrapper">
        ...
        <div class="campo ruta">
            <strong> {{ $factura->predio->ruta .' ' . $factura->predio->barrio->abreviatura }}</strong>
        </div>


    </div>
    {{-- Línea punteada en factura 1 y 2 de cada grupo --}}
    @if (($loop->iteration % 3 == 1 || $loop->iteration % 3 == 2) && !$loop->last)
    <div class="linea-punteada"></div>
    @endif


    {{-- Salto cada 3 facturas --}}
